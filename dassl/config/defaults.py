...
_C.OUTPUT_DIR = f'./output/{datetime.now().strftime("%m%d-%H%M%s")}'
...
_C.TRAINER.DAEL.TASK = ""

# DAELReg
_C.TRAINER.DAELReg = CN()
_C.TRAINER.DAELReg.WEIGHT_U = 0.5
_C.TRAINER.DAELReg.CONF_THRE = 0.95
_C.TRAINER.DAELReg.STRONG_TRANSFORMS = ()
